  ...
  return (
    <div className="mt-24 max-w-[1200px] mx-auto relative">
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        ...
        >
          <TypeAnimation
            sequence={["Full stack Developer", 1000, "Front-End Developer", 1000, "Back-End Developer", 1000]}
            speed={50}
            repeat={Infinity}
          ...
          >
            ...
            <div className="flex gap-2 flex-row text-4xl md:text-6xl text-purple-400 z-20">
      ...
      >
        ...
        <SiJavascript className="text-yellow-600 mx-2" />
